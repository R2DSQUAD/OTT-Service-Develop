...
const MovieIndex = () => {
  ...
  return (
    <>
    {movieModal && <MovieModal modalitem={modalitem} setMovieModal={setMovieModal}/>}
    <div className="movie">
      <div className="movie-con">
         ...
         <div className="comedy">
          <h1>코미디</h1>
          <ul>
          {movieList && movieList.map((el,index)=>{
            if(el.genre === "코미디"){
            return(
            <li key={index}>
                <div className='image'> 
                    <img src={`/images/movie/${el.img}`} alt={el.img} onClick={onMovieModalFn} key={index} data-id={el.id} data-genre={el.genre} data-title={el.title} data-comment={el.comment} data-price={el.price}/>
                </div>
            </li>
            );}
